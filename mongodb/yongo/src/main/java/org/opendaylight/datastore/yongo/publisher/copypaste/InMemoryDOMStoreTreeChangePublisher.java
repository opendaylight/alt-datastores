 ...
 */
package org.opendaylight.datastore.yongo.publisher.copypaste;
...
public final class InMemoryDOMStoreTreeChangePublisher extends AbstractDOMStoreTreeChangePublisher {
    ...
    public InMemoryDOMStoreTreeChangePublisher(final ExecutorService listenerExecutor, final int maxQueueSize) {
    ...
    public synchronized boolean publishChange(final @NonNull DataTreeCandidate candidate) {
